...
Feature:  ConfigThreshhold
   ...
   Scenario:Test to verify whether Opco User can Configure High Usage Threshold for a CSP
     ...
     |High Usage |Action|Select_Dropdown_Warning|
     ...
     |High usage for SMS MO |Action|Select_Dropdown_Daily report|
     ...
     Then verify if "drp_Haction1" "equal" "Warning"
     ...
     Then verify if "drp_Haction3" "equal" "Daily report"
      Then logout
   ...
   Scenario:Test to verify whether Opco User can Configure Rogue Usage Threshold for a CSP
      ...
      |Rogue usage for CS |Action|Select_Dropdown_Warning|
     ...
     Then verify if "drp_Raction2" "equal" "Warning"
