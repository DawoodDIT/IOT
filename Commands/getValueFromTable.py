...
def getValueFromTable(self,col_to_check,colnames,rowvalues):
    ...
    if desired_row != None:
        ...
        try:
            ...
            return all_c[col_to_click_index].text
        except:
    ...
    Module.RecordTime.calculateTime("getValueFromTable", time.perf_counter() - t1)
