...
def clickOnMobileOption(driverObject,optionName):
    ...
    obj = Module.getMobileObject.getMobileObjByRepo(driverObject,"textoption",optionName)
    if obj != None:
        try:
            obj.click()
    ...
    if success == 0:
        obj = Module.getMobileObject.getMobileObjByAlgo(driverObject,"textoption",optionName)
        if obj != None:
            try:
                obj.click()
                Module.logger.INFO("Option" + optionName + " is clicked")
